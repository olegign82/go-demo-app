...
| APP-VOLUMEMOUNTS              || Prompt string to generate app-volumeMounts.yaml file | [Link to app-volumeMounts.yaml file](/yaml/app-volumeMounts.yaml)   |
| APP-CRONJOB                   || Prompt string to generate app-cronjob.yaml file | [Link to app-cronjob.yaml file](/yaml/app-cronjob.yaml)   |
| APP-JOB                       || Prompt string to generate app-job.yaml file | [Link to app-job.yaml file](/yaml/app-job.yaml)   |
| APP-MULTICONTAINER            || Prompt string to generate app-multicontainer.yaml file | [Link to app-multicontainer.yaml file](/yaml/app-multicontainer.yaml)   |
| APP-RESOURCES                 || Prompt string to generate app-resources.yaml file | [Link to app-resources.yaml file](/yaml/app-resources.yaml)   |
| APP-SECRET_ENV                || Prompt string to generate app-secret-env.yaml file | [Link to app-secret-env.yaml file](/yaml/app-secret-env.yaml)   |
#
