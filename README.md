...
| APP-READINESSPROBE            || Prompt string to generate app-readinessProbe.yaml file| [Link to app-readinessProbe.yaml file](/yaml/app-readinessProbe.yaml) |
| APP-LIVENESSPROBE             || Prompt string to generate app-livenessProbe.yaml file | [Link to app-livenessProbe.yaml file](/yaml/app-livenessProbe.yaml)   |
| APP-LIVENESSPROBE             || Prompt string to generate app-livenessProbe.yaml file | [Link to app-livenessProbe.yaml file](/yaml/app-livenessProbe.yaml)   |
| APP-LIVENESSPROBE             || Prompt string to generate app-livenessProbe.yaml file | [Link to app-livenessProbe.yaml file](/yaml/app-livenessProbe.yaml)   |
| APP-LIVENESSPROBE             || Prompt string to generate app-livenessProbe.yaml file | [Link to app-livenessProbe.yaml file](/yaml/app-livenessProbe.yaml)   |
| APP-LIVENESSPROBE             || Prompt string to generate app-livenessProbe.yaml file | [Link to app-livenessProbe.yaml file](/yaml/app-livenessProbe.yaml)   |
